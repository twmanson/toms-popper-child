...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		<div class="site-info">
			...
			<span class="sep"> | </span>
			<?php printf( esc_html__( 'Parent Theme: %1$s by %2$s.', 'popper' ), 'popper', '<a href="http://mor10.com" rel="designer nofollow">Morten Rand-Hendriksen</a>' ); ?>
			<?php printf( esc_html__( 'Child Theme: %1$s by %2$s.', 'toms-popper-child' ), "Tom's Popper Child", 'Tom Manson' ); ?>
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
</div><!-- #page -->
