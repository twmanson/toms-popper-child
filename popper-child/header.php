...
<?php if(is_page_template('page-templates/page-sidebar-right.php')) {
    ?><div id="page" class="hfeed site <?php echo get_theme_mod( 'layout_setting', 'sidebar-right' ); ?>"><?php
} else if(is_page_template('page-templates/page-sidebar-left.php')) {
	?><div id="page" class="hfeed site <?php echo get_theme_mod( 'layout_setting', 'sidebar-left' ); ?>"><?php
} else {
    ?><div id="page" class="hfeed site <?php echo get_theme_mod( 'layout_setting', 'no-sidebar' ); ?>"><?php
} ?>
